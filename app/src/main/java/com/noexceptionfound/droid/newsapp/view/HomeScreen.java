...
import com.noexceptionfound.droid.newsapp.adapter.NewsArticleAdapter;
import com.noexceptionfound.droid.newsapp.model.NewsArticle;
import com.noexceptionfound.droid.newsapp.utils.AppUtils;
import com.noexceptionfound.droid.newsapp.utils.Constants;
...
public class HomeScreen extends AppCompatActivity
    ...
    private void getTopHeadlinesFromASource(String newsSource){
        StringRequest stringRequest = new StringRequest(GET, Constants.BASE_URL+"top-headlines?sources="+newsSource + Constants.API_KEY_STR + Constants.API_KEY, new Response.Listener<String>() {
            @Override
